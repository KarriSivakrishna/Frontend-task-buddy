        ...
        <div className="px-8 md:px-10 py-8 bg-gradient-to-r from-purple-50/70 to-white">
          ...
          <div className="mt-5 flex flex-col md:flex-row md:items-center md:space-x-6 text-sm text-gray-700 space-y-2 md:space-y-0">
            <div className="flex items-center gap-2">
              ...
              <span>9133661525</span>
            </div>

            <div className="flex items-center gap-2">
              <Mail size={16} className="text-gray-500" />
              <a
                href="mailto:sivakrishna7974@gmail.com"
                className="hover:underline"
              >
                sivakrishna7974@gmail.com
              </a>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <a
                href="https://linkedin.com/in/karrisivakrishna"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:underline"
              >
                 Linkedin/karrisivakrishna
              </a>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <a
                href="https://github.com/KarriSivakrishna"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:underline"
              >
